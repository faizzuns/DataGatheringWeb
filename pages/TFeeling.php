...
if (isset($_POST['op1'])) {
    ...
    $sql = 'INSERT INTO ahmadfai_gather.`question` (ahmadfai_gather.`question`.idtransaction, ahmadfai_gather.`question`.number, ahmadfai_gather.`question`.value) VALUES (' . $_COOKIE["trans"] . ', 1,' . $_POST["op1"] . ')';
    $conn->query($sql);
    $sql = 'INSERT INTO ahmadfai_gather.`question` (ahmadfai_gather.`question`.idtransaction, ahmadfai_gather.`question`.number, ahmadfai_gather.`question`.value) VALUES (' . $_COOKIE["trans"] . ', 2,' . $_POST["op2"] . ')';
    $conn->query($sql);
    $sql = 'INSERT INTO ahmadfai_gather.`question` (ahmadfai_gather.`question`.idtransaction, ahmadfai_gather.`question`.number, ahmadfai_gather.`question`.value) VALUES (' . $_COOKIE["trans"] . ', 3,' . $_POST["op3"] . ')';
    $conn->query($sql);
    $sql = 'INSERT INTO ahmadfai_gather.`question` (ahmadfai_gather.`question`.idtransaction, ahmadfai_gather.`question`.number, ahmadfai_gather.`question`.value) VALUES (' . $_COOKIE["trans"] . ', 4,' . $_POST["op4"] . ')';
    $conn->query($sql);
    $conn->close();
